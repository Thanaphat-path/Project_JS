<?php
    ...
    class DB_con{
        ...
        public function insert_user($Type, $Username, $Password){
            $result = mysqli_query($this->dbcon, "INSERT INTO data_user(type, username, password)VALUE('$Type', '$Username', '$Password')");
            return $result;
        }
